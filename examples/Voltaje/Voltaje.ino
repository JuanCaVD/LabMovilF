/*
  Laboratorio movil
  Libreria del labotario movil: Medición de la diferencia de potencia entre las terminales
...
void loop() {
                              // La función "Voltaje" realiza la medición constante diferencia de potencial
  LAB.Voltaje();              // y la imprime en la lcd, monitor y dispositivo bluetooth
